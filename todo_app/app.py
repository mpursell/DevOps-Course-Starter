...
def create_app():
    ...
    def unauthenticated():
        ...
        return redirect(f'https://github.com/login/oauth/authorize?client_id={client_id}&redirect_uri={callback_uri}')
    ...
    def authenticate():
        ...
        access_token_response = requests.post('https://github.com/login/oauth/access_token', headers=fetch_token_headers, params=fetch_token_params)
        ...
        github_user = requests.get('https://api.github.com/user', headers=fetch_user_headers).json()
